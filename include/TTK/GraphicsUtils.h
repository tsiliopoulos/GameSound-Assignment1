...
namespace TTK
{
	...
	public:
		...
		//static void DrawPrism(TTK::Matrix4x4, TTK::Vector3 colour, float localScale);
		...
		static void SetCameraMode2D(int x, int y, int windowWidth, int windowHeight);
		...
		// Note: This function uses deprecated opengl functions.
		// See TTK::Camera for a modern implementation
		static void SetCameraMode3D(int x, int y, int windowWidth, int windowHeight);
