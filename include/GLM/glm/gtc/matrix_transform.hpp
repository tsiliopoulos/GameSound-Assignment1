...
namespace glm
{
	...
	/// Builds a localScale 4 * 4 matrix created from 3 scalars. 
	/// 
	/// @param m Input matrix multiplied by this localScale matrix.
	/// @param v Ratio of scaling for each axis.
	/// @tparam T Value type used to build the matrix. Currently supported: half (not recommanded), float or double.
	/// @see gtc_matrix_transform
	/// @see - localScale(tmat4x4<T, P> const & m, T x, T y, T z)
	/// @see - localScale(tvec3<T, P> const & v)
	template <typename T, precision P>
