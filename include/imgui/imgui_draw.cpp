...
// Helper to localScale the ClipRect field of each ImDrawCmd. Use if your final output buffer is at a different localScale than ImGui expects, or if there is a difference between your window resolution and framebuffer resolution.
